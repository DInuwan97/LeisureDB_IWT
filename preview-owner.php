...
<div class="single-sctivity-main">
  ...
  <?php
  	include('config/connection.php');
  		...
  		$sql="SELECT p.id as 'addid',p.servicename,p.description,p.category,p.cost,p.usermail,p.status,p.category
  		,p.adminstatus,p.paymentstatus,p.image,p.date,s.fname,s.lname,s.mobile,s.email,s.address,s.status FROM postadd p,staff s WHERE p.id = $id AND p.usermail=s.email ";
        ...
        <div class="provider-info">
            <table border="0">
              <tr>
                ...
                <td style="margin-top: 15px;">Leisure DB - <?php echo $row["category"] ?> Association</td>
              </tr>
              ...
              <tr>
                ...
                <td></td>
                <td></td>
                <td><a href="mailto:<?php echo $row["email"];?>" style="text-decoration: none;">info@leisuredb.lk</a></td>
              </tr>
            ...
            <div class="offline-pay ">
              ...
              <br>
                <p>
                  ...
                  Leisure DB <?php echo $row["category"] ?>'s.
