...
<div class="container">
  ...
  if (isset($_POST["btnsubmit"])){
       ...
       ';
        ...
        $sql="INSERT INTO register(fname,lname,mobile,email,address,postalcode,accountnum,status,pword,cpword)
        VALUES('$fname','$lname','$mobile','$email','$address','$postalCode','$accnum','$status','$pword','$cpword')";
...
<!-- -----------------php end------------------------------------------------------ -->
		...
		<form method="POST" action=""  class="form">
            ...
            <div>            
				<label class="label"><b>Register As :</b></label><br>			
                   <select name="status">
			...
			<div>				
                ...
                <center>        
                  <button type="submit" class="register-btn" onclick = "myFunction();" name="btnsubmit">Register Now</button><br><br>
